                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: ElevatedButton(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                const Text('Sign In with Google', style: TextStyle(fontSize: 16), maxLines: 1, overflow: TextOverflow.ellipsis),
                              ],
                            ),
                          ),
                        ),
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            const Text('Are you a new user?', style: TextStyle(color: Colors.white70), maxLines: 1, overflow: TextOverflow.ellipsis),
                            TextButton(
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                              ...
                              child: const Text('Sign Up', style: TextStyle(color: Colors.purpleAccent), maxLines: 1, overflow: TextOverflow.ellipsis),
                            ),
                          ],
                        ),

                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: _loading
                                ...
                                : const Text('Sign Up with Gmail', style: TextStyle(fontSize: 16), maxLines: 1, overflow: TextOverflow.ellipsis),
                          ),
                        ),
                        const SizedBox(height: 18),
                        Row(
                          ...
                          children: [
                            const Text('Already have an Account?', style: TextStyle(color: Colors.white70), maxLines: 1, overflow: TextOverflow.ellipsis),
                            TextButton(
                              onPressed: () {
                                Navigator.pushReplacement(
                                  context,
                              ...
                              child: const Text('Login', style: TextStyle(color: Colors.purpleAccent), maxLines: 1, overflow: TextOverflow.ellipsis),
                            ),
                          ],
                        ),
                        ...
                        SizedBox(
                          ...
                          child: OutlinedButton(
                            ...
                            child: const Text('Menu', style: TextStyle(fontSize: 16), maxLines: 1, overflow: TextOverflow.ellipsis),
                          ),
                        ),
                      ],
                    ),
